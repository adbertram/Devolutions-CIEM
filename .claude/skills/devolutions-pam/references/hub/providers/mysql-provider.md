...
**Source URL:** https://docs.devolutions.net/pam/hub/providers/mysql-provider/

---

The MySQL provider in Devolutions Hub Business enables secure, centralized management of MySQL privileged accounts.
General
OPTION
DESCRIPTION
Name
...
Hostname
(required)
Enter the MySQL serverâs address.
Port
Type the port number.
Username
(required)
Provide the MySQL user account.
Password
(required)
Enter the associated password for the MySQL user.
Checkout policy
OPTION
DESCRIPTION
...
DESCRIPTION
Password rotation
Select the password policy. Password policies are created inÂ
Administration
â
Management
â
...
*Downloaded on: 2026-02-18 13:10:03*