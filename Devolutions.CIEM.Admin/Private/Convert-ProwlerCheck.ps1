...
"@
    ...
    if (-not $OutputDirectory) {
        ...
        $OutputDirectory = Join-Path -Path $script:ChecksRoot -ChildPath 'Checks' -AdditionalChildPath $providerDisplayName
    }
    ...
    if (-not $ScriptOnly) {
        ...
        $ciemChecksPath = Join-Path $script:ChecksRoot 'ciem_checks.json'
