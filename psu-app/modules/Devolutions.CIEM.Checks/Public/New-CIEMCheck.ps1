function New-CIEMCheck {
    ...
    process {
        ...
        foreach ($item in $items) {
            ...
            if ($existing) { throw "Check '$cId' already exists. Use Update-CIEMCheck or Save-CIEMCheck." }

            Invoke-CIEMQuery -Query @"
INSERT INTO checks (id, provider, service, title, description, risk, severity, remediation_text, remediation_url, related_url, check_script, disabled, permissions, depends_on)
