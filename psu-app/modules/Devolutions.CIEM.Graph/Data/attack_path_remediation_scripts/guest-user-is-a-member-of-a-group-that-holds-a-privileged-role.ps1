...
It removes the guest user from the privileged Entra group that contributes to the
attack path. The commands are generated from the group membership edges in the
finding and execute with the Azure REST API under the selected CIEM authentication profile
context. Review the user, group, and inherited role before running the
