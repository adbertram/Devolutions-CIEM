BeforeAll {
    ...
    $script:ModuleCommandPattern = '^(Write-CIEMLog|Get-SeverityColor|Get-StatusColor|Get-PSUInstalledEnvironment|Invoke-CIEMJobWithProgress|New-CIEM(?:ErrorContent|InfoContent|SuccessContent)|Connect-CIEM|Send-CIEMNotification|Set-CIEMSecret|Save-CIEMAuthenticationProfile|Remove-CIEMAuthenticationProfile|Set-CIEMAuthenticationProfileAssignment|Set-CIEMAzureDiscoverySchedule|Set-CIEMNotificationChannel|Update-CIEMProvider|Invoke-CIEMQuery|Get-CIEM(?:AuthenticationProfile|AuthenticationProfileAssignment|AzureArmHierarchy|AzureDiscoveryRun|AzureDiscoverySchedule|AzureIdentityHierarchy|AttackPath|AttackPathRemediationScript|Check|Config|ConnectorPayloadPreview|ExposureChange|IdentityRiskSignals|IdentityRiskSummary|Notification|NotificationChannel|NotificationHistory|PAMProgressSummary|PSUJobOutput|Provider|ProviderAuthMethod|ScanEfficiencySummary|ScanRun|Secret))$'
