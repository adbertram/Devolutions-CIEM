function New-CIEMGraph {
    ...
    $permRelationships = @(Get-CIEMPermissionRelationship)
    if ($permRelationships.Count -gt 0) {
        ...
        Write-Warning "No permission relationships found in database — computed edges skipped."
    }
