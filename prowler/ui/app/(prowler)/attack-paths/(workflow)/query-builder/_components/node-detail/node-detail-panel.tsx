    ...
    <div className="flex flex-col gap-6">
      ...
      <Card className="border-border-neutral-secondary">
        <CardContent className="flex flex-col gap-3 p-4">
          <h3 className="dark:text-devolutions-theme-pale/90 text-sm font-semibold">
            Node Overview
          </h3>
...
export const NodeDetailPanel = ({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={(open) => !open && onClose?.()}>
      <SheetContent className="dark:bg-devolutions-blue-400 my-4 max-h-[calc(100vh-2rem)] max-w-[95vw] overflow-y-auto rounded-l-xl pt-10 md:my-8 md:max-h-[calc(100vh-4rem)] md:max-w-[55vw]">
        <SheetHeader>
