...
const TRIGGER_STYLES = {
  ...
  underline:
    "after:absolute after:bottom-0 after:left-1/2 after:h-0.5 after:w-0 after:-translate-x-1/2 after:bg-blue-400 after:transition-all data-[state=active]:after:w-[calc(100%-theme(spacing.5))]",
  focus:
    "focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white focus-visible:outline-none dark:focus-visible:ring-offset-slate-950",
